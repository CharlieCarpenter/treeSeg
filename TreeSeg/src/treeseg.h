...
List boundsCall_CC(const arma::vec x, const Rcpp::NumericVector& lengths, double alpha = 0.05, double q = NA_REAL, int fam = 0);
...
double mlCost_CC(arma::mat X, arma::mat K, arma::vec R, double s2, double df, int fam = 0);
